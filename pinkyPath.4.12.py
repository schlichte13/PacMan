...
from PacMan.saveFile import saveFile
...
def menuWork(game, score, lives):
    ...
    playerStretchedImage = pygame.transform.scale(playerImage, (15, 15))
    playerStretchedLeft = pygame.transform.scale(playerImageLeft, (15, 15))
    playerStretchedRight = pygame.transform.scale(playerImageRight, (15, 15))
    playerStretchedUp = pygame.transform.scale(playerImageUp, (15, 15))
    playerStretchedDown = pygame.transform.scale(playerImageDown, (15, 15))
    ...
    #same as above but for inky
                ...
                if frightenedB == True:
                    ...
                    for j in nodes:
                        if ghost.contains(nodes[j]):
                            ...
                            #if len(pathb) <= 1:
                                #if ghostPos == playerPos:
                                    #dijsktra(graph, positionA[0], ghostPos, path)
                                    #pathb = path
                                    #next_spot = nodes.get(pathb[1])
                                    #print(pathb)
                                #else:
        ...
        #if frightenedB == False and eatenB == False:
        if playerChange > 150:
