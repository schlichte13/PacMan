...
ex1 = pygame.Rect(80, 215, 20, 20)
ex2 = pygame.Rect(410, 215, 20, 20)
...
while True:
    ...
    if player.colliderect(ex1):
        playerPos = 'ex1'

    if player.colliderect(ex2):
        playerPos = 'ex2'
    ...
    pygame.draw.rect(windowSurface, WHITE, ex1)
    pygame.draw.rect(windowSurface, WHITE, ex2)
